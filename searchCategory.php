...
// Check if category name is provided in the URL
if (isset($_GET['ctgname'])) {
    $categoryName = $conn->real_escape_string($_GET['ctgname']);
}

// SQL query to retrieve data from the Posts and PostCategories tables with a category filter
